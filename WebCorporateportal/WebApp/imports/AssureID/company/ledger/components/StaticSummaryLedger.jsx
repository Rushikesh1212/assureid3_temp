...
class StaticSummaryLedger extends TrackerReact(Component) { 
  constructor(){
    super();
  }
    ...
    if (!this.props.loading) {
      return ( 
        this.props.assureId == "IN-CAA-000001"?
         <div className="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 noProfilePadding landingBlocks latestUpadatesBlock1 placeholderVerBlock">
         ...
         :
         <div className="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 latestUpadatesBlock1 noProfilePadding landingBlocks">
            {/* <h5 className="text-center"><b>Verification Dashboard</b></h5> */}
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 summaryDivRule">
                      <div className="col-lg-8 col-md-8 col-sm-10 col-xs-10">Total Cases Received</div> 
...
StaticSummaryLedgerContainer = withTracker(props => {
...
export default StaticSummaryLedgerContainer;
