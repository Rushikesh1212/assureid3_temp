...
class CorporateFooter extends TrackerReact(Component) {
  constructor(){
    super();
    this.state ={
    }
  ...
  render() {
    // console.log("this.props.companyInfo :",this.props.companyInfo ? this.props.companyInfo.length: 0);    
...
CorporateFooterContainer = withTracker(props => {
...
export default CorporateFooterContainer;
