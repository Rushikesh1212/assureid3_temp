            ...
            <ScrollView createContainerStyle={{marginBottom: 25,borderWidth:0,margin:0}}>
                <View>
                        ...
                        <View style={styles.cardHeader}>
                          <View style={{flexDirection:'row',flex:1,}}>
                            ...
                            <View style={{flex:.8}}>
                              ...
                              {/*<Text>{academicsDetails.dateAtotendedFrom ? academicsDetails.dateAttendedFrom+' - ':''} {academicsDetails.dateAttendedTo}</Text>*/}
                  ...
                  :
                    ...
                    <View><Text style={{paddingHorizontal:22,paddingBottom:10}}>Please add your Academics Information</Text></View> 
                              ...
                              { this.props.currentId ?
                                ...
                                <View style={{flex:.2,alignItems:'flex-end'}}>
                                  <View style={{flexDirection:'row',paddingRight:5}}>
                                    <View style={{alignItems:'flex-end',paddingRight:8,marginTop:5}}>
                                ...
                                <View style={{flexDirection:'row',paddingRight:5}}>
                                  <View style={{flexWrap: 'wrap'}}>
                                      <View><Text>Order No : {professionalsDetails.orderNo}</Text></View>
                                      <View><Text>Status : {professionalsDetails.verifiedStatus}</Text></View>
                  ...
                  :
                    <View>
                      {/*<Text style={{paddingHorizontal:22,marginBottom:10}}>Please add your Academics Information</Text>*/}
                    </View>
                  }
