...
import Skills from '/imports/AssureID/userPortal/profile/forms/components/Skills.jsx';
  ...
  render() {
    ...
    return (
    	<div>
            ...
            this.props.skillData.length > 0 ?
	            this.props.skillData.map((skillsDetails,index)=>{ 
	              return(
                  skillsDetails == null ?
                  <div className="nopadLeft col-lg-4 col-md-6 col-sm-6 col-xs-12" key={index}>
                  </div>
                  :
	                <div className="nopadLeft col-lg-4 col-md-6 col-sm-6 col-xs-12" key={index}>
              ...
              :
                FlowRouter.current().path == "/viewProfile/"+this.props.currentId ?
                Meteor.userId() == this.props.currentId ?
                  <span className="col-lg-12 col-md-12 col-sm-12 col-xs-12 noProfilePadding">Please add your skill set</span>
                :
