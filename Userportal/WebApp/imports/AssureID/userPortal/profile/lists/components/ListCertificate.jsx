                            ...
                            <div>
                              <div className="col-lg-1 col-md-1 col-sm-1 col-xs-1 NOpadding">
                               <div className="add-btn col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadRight">
                                <i onClick={this.editCertificate.bind(this)} title="Edit Certificate" className="fa fa-pencil edit-pencil pull-right" data-toggle="modal" data-target={"editcertificateinfo-"+index}></i>
                               </div>
                              </div>
                              <div className="col-lg-1 col-md-1 col-sm-1 col-xs-1 NOpadding">
                                <div className="add-btn col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <i className="fa fa-trash edit-pencil pull-right" title="Delete Certificate" data-toggle="modal" onClick={this.editCertificate.bind(this)} data-target={"deleteCertificateInfo-"+index}></i>
                                </div>
                              </div>
                            </div>
                          :
