...
Meteor.methods({
  'addUserImage': function (id,userId,userFileName,userFileExt) {
     ...
     Meteor.users.update(
      {'_id': userId },
      {
        $set:{
          ...
          "profile.userFileName" : userFileName,
          "profile.userFileExt"  : userFileExt,
        } //End of set
      }
    );
    Meteor.call('updateUserProfile',userId,imageLink,userFileName,userFileExt);
  },
