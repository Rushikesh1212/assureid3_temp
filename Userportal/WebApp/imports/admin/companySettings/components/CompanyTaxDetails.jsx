            ...
            <form id="companyTaxForm" className="companyTaxForm">
              <div className="form-group col-lg-6 col-md-4 col-sm-12 col-xs-12">
                <div className="input-group">
                 ...
                 <input value={this.state.taxType} onChange={this.handleChange} type="text" placeholder="Enter Tax Type" name="taxType" className="form-control taxType inputValid"/>
                </div>
              </div>
              ...
              <div className="form-group col-lg-6 col-md-4 col-sm-12 col-xs-12">
               ...
               <div className="form-group col-lg-6 col-md-4 col-sm-12 col-xs-12">
                <div className="input-group">
                   ...
                   <input value={this.state.effectiveFrom} onChange={this.handleChange} type="date"  name="effectiveFrom" className="form-control effectiveFrom inputValid" />
                </div>
              </div>
