								...
								<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div className="form-group">
									 <label className="col-lg-6 label-category">Template Type<span className="astrick">*</span>:</label>     						
								      <select className="form-control templateType" name="templateType" ref="templateType" onChange={this.selectType.bind(this)} value={this.state.templateType} required>
								...
								<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div className="form-group">
									 ...
									 <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding"> 
									 	...
									 	<textarea name="content" ref="content" value={this.state.content}  className="templateName  col-lg-12 col-md-12 col-sm-12 col-xs-12" rows="10" onChange={this.handleChange} required></textarea>
									 </div> 						
									</div>	
								</div>
							</div>
