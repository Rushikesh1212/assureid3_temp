...
class CorporateOpenOrders extends TrackerReact(Component){
	constructor(props){
        super(props);
        this.state = {
        } 
  ...
  render(){
    console.log("this.props.allocatedCorporateOrders :",this.props.allocatedCorporateOrders);
                ...
                <div className="col-md-12">
                  <div className="box">
                    <div className="box-header with-border">
                      <h2 className="box-title"> Open Orders</h2> 
                    </div>
...
CorporateOpenOrdersContainer = withTracker(props => { 
    ...
    // console.log('allocatedCorporateOrders1: ', allocatedCorporateOrders1);
    var addNoOfDays = 2;
    ...
    for(var i=0;i<allocatedCorporateOrders1.length;i++){
      ...
      if(allocatedCorporateOrders1[i].DEOStatus == "New"){
        ...
        if(afterAddDaysDate >= new Date()){
          ...
          allocatedCorporateOrders1[i].bgClassName = 'btn-primary';                         
        }
        allocatedCorporateOrders.push(allocatedCorporateOrders1[i]);
      }else{
        allocatedCorporateOrders1[i].status      = 'In Process' ;
        allocatedCorporateOrders1[i].bgClassName = 'btn-warning';                
        allocatedCorporateOrders.push(allocatedCorporateOrders1[i]);
...
export default CorporateOpenOrdersContainer;
