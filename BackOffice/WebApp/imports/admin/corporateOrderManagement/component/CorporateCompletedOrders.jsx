...
class CorporateCompletedOrders extends TrackerReact(Component){
	constructor(props){
   super(props);
      this.state = {
      } 
                ...
                <div className="col-md-12">
                  <div className="box">
                    <div className="box-header with-border">
                      <h2 className="box-title"> Complete Orders</h2> 
                    </div>
...
CorporateCompletedOrdersContainer = withTracker(props => { 
    ...
    for(var i=0;i<allocatedCorporateOrders1.length;i++){
      ...
      if(allocatedCorporateOrders1[i].DEOStatus == "Completed"){
        allocatedCorporateOrders1[i].status      = 'Completed' ;
        if(afterAddDaysDate >= new Date()){
          allocatedCorporateOrders1[i].bgClassName = 'btn-danger';        
        }else{
          allocatedCorporateOrders1[i].bgClassName = 'btn-success';                                 
        }
...
})(CorporateCompletedOrders);
export default CorporateCompletedOrdersContainer;
