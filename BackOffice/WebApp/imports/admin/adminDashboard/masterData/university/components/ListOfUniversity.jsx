...
import { University } from '/imports/admin/adminDashboard/masterData/university/api/University.js';

class ListOfUniversity extends TrackerReact(Component) {
  constructor(props) {
    super(props); 
    this.state = {
      university : [],
  ...
  renderTableRow(){
    return this.props.university.map((university,index) =>{
      ...
      return <tr key={index}>
              ...
              <td>
                <a href={'/admin/University/'+university._id} className="editButton" title="Edit">
...
ListOfUniversityContainer = withTracker(({props}) => {
    const postHandle = Meteor.subscribe('university');
...
export default ListOfUniversityContainer;
