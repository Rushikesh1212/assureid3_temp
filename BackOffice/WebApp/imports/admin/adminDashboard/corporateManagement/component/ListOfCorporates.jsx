...
class ListOfCorporates extends TrackerReact(Component) {
	constructor(props) {
    super(props); 
    this.state = {
      "subscription"  : {
      ...
      if(emails.length>0){
        emails.map((emailsData,index)=>{
          var msgvariable = {    
            ...
            '[assureid]'   : companyDetails.companyAssureID,
           ...
           <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <div className="box box-primary">
                ...
                <div className="box-body">  
                  <div className="dataTable table-responsive tableBasicPage col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              return( <tr key={index}>
                                        ...
                                        <td className="actiontd">
                                          {companies.contract ?
                                            ...
                                            :
                                            <a href={"/admin/AddNewContract/"+companies._id}>
...
ListOfCorporatesContainer = withTracker(({props}) => {
...
export default ListOfCorporatesContainer;