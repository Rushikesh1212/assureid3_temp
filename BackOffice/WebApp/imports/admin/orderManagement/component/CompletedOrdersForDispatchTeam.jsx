                ...
                <div className="col-md-12">
                  <div className="box">
                    <div className="box-header with-border">
                      <h2 className="box-title"> My Complete Orders</h2> 
                    </div>
...
CompletedOrdersForDispatchTeamContainer = withTracker(props => { 
...
export default CompletedOrdersForDispatchTeamContainer;
