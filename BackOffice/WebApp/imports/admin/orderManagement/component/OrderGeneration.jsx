...
class OrderGeneration extends TrackerReact(Component){
  ...
  getCanvas(cachewidth){
    html2canvas($('#orderGenerationwrap').get(0)).then( function (canvas) {
    var orderGenerationwrap = $('#orderGenerationwrap');
      ...
      if(canvas.width > canvas.height){
        ...
        var doc = new jsPDF('p', 'mm','a4',[canvas.height, canvas.width]);
          ...
          doc.save('GenratedOrder.pdf');
          orderGenerationwrap.width(cachewidth);
    });
  }
    ...
    if (!this.props.loading) {
      return (
        <div className="col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 orderGenerationwrap" id="orderGenerationwrap">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding generationHeader"> 
            ...
            <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8">
             ...
             <div className="col-lg-1 col-md-1 col-sm-12 col-xs-12 outerpdficonatorder">
                <i className="fa fa-download pull-right fa-2x pdf-icon" title="Download as pdf" onClick={this.downloadOrderaspdf.bind(this)}></i>
              </div>
            </div>
          </div>
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 generationInfo noLRPad">
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 noLRPad">
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding rowOuterWrap">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding rowOuterWrap">
                  <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 reportLabel">AssureID <span className="pull-right">:</span></div>
                  <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 valueLabel">{this.props.orderCandidate ? this.props.orderCandidate.candidateAssureID : "-"}</div>
                </div>
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding rowOuterWrap">
                  <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 reportLabel">Order Reference <span className="pull-right">:</span></div>
                  <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 valueLabel">{this.props.getOrder ? this.props.getOrder.orderNo : "-"}</div>
                </div>
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding ">
                  <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 reportLabel">Order Date <span className="pull-right">:</span></div>
                  <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 valueLabel">{this.props.getOrder ? moment(this.props.getOrder.createdAt).format('DD-MM-YYYY') : "-"}</div>
                </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 noLRPad">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding rowOuterWrap">
                  <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 reportLabel">Report Date <span className="pull-right">:</span></div>
                  <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 valueLabel">{this.props.getOrder ? moment(this.props.getOrder.completedDate).format('DD-MM-YYYY') : "-"} </div>
                </div>
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding rowOuterWrap">
                  <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 reportLabel">Result <span className="pull-right">:</span></div>
                  <div className={"col-lg-8 col-md-8 col-sm-8 col-xs-8 valueLabel "+this.props.textColor}><b>{this.props.getOrder ? this.props.getOrder.orderStatus : "-"}</b></div>
                </div>
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
                  <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 reportLabel">Report Level <span className="pull-right">:</span></div>
                  <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 valueLabel">Standard</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
            <h3 className="col-lg-10 col-md-10 col-sm-12 col-xs-12 execHead">EXECUTIVE SUMMARY</h3>
            { 
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3 className="execHead">SUMMARY OF FINDINGS</h3>
...
export default OrderGenerationContainer = withTracker(props => {
  // console.log("Inside orderManagement");
  ...
  if(getOrder){
    ...
    for(i = 0 ; i < getOrder.candidateDetails[0].verificationData.length; i++ ){
      ...
      if(ticketDetails){
        ...
        }else if (ticketDetails.verificationType == "reference") {
          data.ticketInfo = ticketDetails.verificationData.referralFirstName + ' - ' + ticketDetails.verificationData.referralLastName;
          data.ticketVerification = 'Reference Verification';
        }
        // console.log("data");
        // console.log(data);
        if (ticketDetails.reportGenerated) {
          if (ticketDetails.reportGenerated.documents) {
