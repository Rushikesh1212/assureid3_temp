...
export default class UMUserportal extends TrackerReact(Component) {
  ...
  'deleteUserConfirm'(event){
	...
	render(){
		console.log("usersDataValues :",this.props.usersDataValues);
   return(
				<tr className="">
					...
					<td className="col-lg-1 col-md-1"> 
						<a href={`/admin/edituserprofile/${this.props.usersDataValues._id}`}><button type="button" className="fa fa-pencil-square-o editUser"> </button> </a> 
