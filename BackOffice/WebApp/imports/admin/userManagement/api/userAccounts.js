...
import { UserImage } from "../UserPicUploadServer/UserPicUploadServer.js";
...
Meteor.methods({
      ...
      Meteor.users.update(
        {'_id': id },
        {
          $set:{
            ...
            "profile.area"         : formValues.area,
            "profile.state"        : formValues.state,
            "profile.country"      : formValues.country,
            "profile.pincode"      : formValues.pincode,
  ...
  'addOTP' : function(newID,mobileotp,emailotp) {
    var sucess = Meteor.users.update(
      {'_id': newID },
      {
        $set:{
  ...
  'sendEmailnNotification': function (to , from, subject ,body) {
    console.log("to , from, subject ,body :",to , from, subject ,body);
    this.unblock();    
      Email.send({
        to: to,
        from: from,
  ...
  'createUserAccountByCompany' : function(formValues){
    var newUserId = Accounts.createUser({
      ...
      profile     : {   
        ...
        userProfile   : 'https://s3.ap-south-1.amazonaws.com/assureidportal/backofficeImages/userIcon.png',
...
Meteor.startup(() => {  
  var data = "smtp://testassureid:assureid@123@smtp.googlemail.com:587";
  // var data = "smtps://support%40assureid.in@%4055U%21d%23@mail.innowavegroup.in:465";
  // smtp = {
  //   username: 'support',   // eg: server@gentlenode.com
  //   password: '@55U!d#',   // eg: 3eeP1gtizk5eziohfervU
  //   // password: '%4055U%21d%23',   // eg: 3eeP1gtizk5eziohfervU
  //   server:   'smtp.innowavegroup.in',  // eg: mail.gandi.net
  //   port: 465
  // }
// smtp = {
//     username: 'testassureid',   // eg: server@gentlenode.com
//     // password: '@55U!d#',   // eg: 3eeP1gtizk5eziohfervU
//     password: '123',   // eg: 3eeP1gtizk5eziohfervU
//     server:   'smtp.googlemail.com',  // eg: mail.gandi.net
//     port: 587
//   }

  // var data = 'smtps://' + encodeURIComponent(smtp.username) + ':' + encodeURIComponent(smtp.password) + '@' + encodeURIComponent(smtp.server) + ':' + smtp.port;
  // console.log('data ',data);
  process.env.MAIL_URL = data;


  Accounts.emailTemplates.siteName = "ASSUREiD";
  Accounts.emailTemplates.from = 'ASSUREiD Admin<karishma.kottarwar@gmail.com>';
  // Accounts.emailTemplates.from = 'ASSUREiD Admin<support@assureid.in>';
