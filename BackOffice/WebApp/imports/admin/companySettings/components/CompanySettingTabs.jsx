        ...
        <div className="content-wrapper">
          ...
          <section className="content-header">
            ...
            <ol className="breadcrumb">
              <li>
                <a href="#"><i className="fa fa-dashboard"/>
                  Home</a>
              </li>
                      ...
                      <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div className="reportWrapper">
                            ...
                            <div id="parkingreport" className="ReportTabs col-lg-3 col-md-3 col-sm-12 col-xs-12">
                              <ul className="nav nav-pills">
                                <li className="active transactionTab CStab col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <a data-toggle="pill" href="#companyInformation" className="">
                                    Company Information
                                  </a>
                                </li>
                                <li className="col-lg-12 col-md-12 col-sm-12 col-xs-12 transactionTab CStab">
                                ...
                                <li className="col-lg-12 col-md-12 col-sm-12 col-xs-12 transactionTab CStab">
                                  <a data-toggle="pill" href="#CompanyTicketAllocation">
                                    Maximum Case Allocation
                                  </a>
                                </li>
                              </ul>
                            </div>
{/*                            <div className="break col-lg-12 col-md-12"></div>*/}
                            <div className="tab-content">
                              ...
                              <div id="CompanyTicketAllocation" className="tab-pane fade">
