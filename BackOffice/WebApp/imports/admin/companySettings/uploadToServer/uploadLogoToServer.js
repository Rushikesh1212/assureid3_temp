...
import { ProjectSettings } from '/imports/common/api/projectSettings.js';
    ...
    if (process.env.S3) {
        ...
        if (s3Conf && s3Conf.key && s3Conf.secret && s3Conf.bucket && s3Conf.region) {
            ...
            export const CompanySettingLogoImage = new FilesCollection({
                ...
                storagePath    : 'CompanySettingLogoImage',
                ...
                onAfterUpload(fileRef) {
                    ...
                    _.each(fileRef.versions, (vRef, version) => {
                        ...
                        const filePath = 'CompanySettingLogoImage/' + fileRef._id +'.' + fileRef.extension;
                        s3.putObject({
            ...
            const _origRemove = CompanySettingLogoImage.remove;
            CompanySettingLogoImage.remove = function(search) {
