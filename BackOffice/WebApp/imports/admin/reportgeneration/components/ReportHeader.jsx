    ...
    html2canvas($('#outerReport').get(0)).then( function (canvas) {
      ...
      if(canvas.width > canvas.height){
        ...
        var doc = new jsPDF('p', 'mm','a4',[canvas.height, canvas.width]);
          ...
          doc.addImage(img, 'JPEG', 0, position, width, imgHeight);
          // doc.addImage(img, 'PNG', 0, position, width, imgHeight);
          heightLeft -= height;
          // console.log("heightLeft",heightLeft);
          while (heightLeft >= 0) {
          ...
          <div className={this.props.url == 'reportHeader' ? "col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 reportHeaderBoxShadow" : "col-lg-12 col-md-12 col-sm-12 col-xs-12 reportHeaderBoxShadowQTL"} id="outerReport">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding generationHeader"> 
              ...
              <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 outerpdficon">
                <i className="fa fa fa-download pull-right fa-2x pdf-icon" title="Download as pdf" onClick={this.downloadReportaspdf.bind(this)}></i>
              </div>
            </div>
