...
import OrderSummary from '/imports/dashboard/reportgeneration/components/OrderSummary.jsx';
import OrderSummaryTable from '/imports/dashboard/reportgeneration/components/OrderSummaryTable.jsx';
import ReportGeneration from '/imports/dashboard/reportgeneration/components/ReportGeneration.jsx';
        ...
        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 generationInfo">
          <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding orderinfodiv">
              ...
              <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8">{this.props.orderCandidate ? this.props.orderCandidate.candidateFirstName+" "+this.props.orderCandidate.candidateLastName : "-"}</div>
            </div>
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding orderinfodiv">
...
export default OrderGenerationContainer = withTracker(props => {
  ...
  // console.log("Inside reportgeneration ordergeneration");
